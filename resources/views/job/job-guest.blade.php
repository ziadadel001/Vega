            ...
            <div class="main-box-net" id="data-container">
                @foreach ($jobs as $job)
                    <div class="box card course">
                        <a href="{{ route('ShowOneJob.create',$job->id) }}">
                            <div class="ele-between content-group">
                                ...
                                <div class="apply">
                                    <div class="full">{{ $job->job_type }}</div>
