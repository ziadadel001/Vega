...
@section('content')
    <div class=" container quiz">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"> <img src="{{ asset('Assets/img/home.png') }}"
                            alt="">Home</a></li>
                <li class="breadcrumb-item "><a href="RoadmapPage.html">Roadmap</a></li>
                <li class="breadcrumb-item"><a href="#">DataScience</a></li>
                <li class="breadcrumb-item"><a href="#">CustomRoadmap</a></li>
                <li class="breadcrumb-item"><a href="#">Skills</a></li>
                <li class="breadcrumb-item active"><a href="#">َQuiz</a></li>
            </ol>
        </nav>
        <p>Skill Quiz</p>
        <div class="bar">
        ...
        <!-- Result Box -->
        <div class="start_btn" style="display: none;"><button>Start Quiz</button></div>

        <!-- Info Box -->
        <div class="info_box">

            <div class="buttons">
                <button class="quit" style="display: none;">Exit Quiz</button>
    ...
    <div class="popup">
        <div class="popup-content">
            ...
            <p>153412121213</p>
            <img src="{{ asset('Assets/img/aii.png') }}" alt="">
            <div class="result">321322321</div>
        </div>
    </div>
